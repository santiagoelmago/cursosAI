...
<div class="mb-8 flex items-center justify-between">
  <div>
    ...
    <p class="text-surface-500 dark:text-surface-400">Build and manage your WhatsApp course catalog.</p>
  </div>
  <a href="/courses/new">
    <Button>
...
{#if courses.length === 0}
  <div class="bg-white dark:bg-surface-900 border border-dashed border-surface-300 dark:border-surface-700 rounded-2xl p-16 text-center">
    ...
    <h3 class="font-semibold text-xl mb-2">Create your first course</h3>
    <p class="text-surface-500 dark:text-surface-400 text-sm mb-6 max-w-md mx-auto">
      Build a sequence of WhatsApp messages — a 21-day challenge, a coaching program, a mini-course. Students enroll and receive your content automatically.
    </p>
    <a href="/courses/new">
      <Button size="lg">
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
    {#each courses as course}
      <a href="/courses/{course.id}" class="bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-800 rounded-xl p-5 hover:border-brand-500 dark:hover:border-brand-500 transition-colors group block">
        ...
        <p class="text-sm text-surface-500 dark:text-surface-400 line-clamp-2 mb-3">{course.description || 'No description'}</p>
